...
// const Page: React.FC = () => {
//   return (
//     <main className="flex flex-col items-center justify-center min-h-screen px-4 md:px-20 bg-gray-50">
//       <header className="flex flex-col items-center mb-8 text-center">
//         <h1 className="text-4xl font-bold text-blue-500 md:text-6xl">
//           🐋 Docker
//         </h1>
//         <h1 className="mt-6 text-xl font-bold text-gray-600 md:text-3xl">
//           Welcome to Your Dockerized Next.js Project 🚀
//         </h1>
//         <p className="mt-4 text-sm text-gray-600 md:text-md">
//           Start building and deploying your Next.js app with Docker in minutes!
//         </p>
//       </header>
...
const Page: React.FC = () => {
  return (
    <main className="flex flex-col items-center justify-center min-h-screen px-4 py-10 bg-gray-50 ">
      <header className="flex flex-col items-center mb-4 text-center md:mb-8">
        <h1 className="text-4xl font-bold text-blue-500 md:text-6xl">
          🐋 Docker
        </h1>
        <h1 className="mt-6 text-xl font-bold text-gray-600 md:text-3xl">
